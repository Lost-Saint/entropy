var app = (function () {
	...
	mark_module_start();
	Dashboard[FILENAME] = "src/lib/dashboard.svelte";

	var root = add_locations(template(`//src/lib/dahsboard.svelte <main class="w-screen h-screen flex justify-center items-center text-3xl font-semibold"><h1>Hello world</h1></main>`, 1), Dashboard[FILENAME], [[2, 0, [[5, 4]]]]);
