var app = (function () {
	...
	var root = add_locations(template(`<main class="flex flex-col justify-center items-center"><h1 class="bg-blue-600"> </h1> <button class="bg-blue-600 px-[6px] py-[14px] mt-6 text-white font-semibold">Click me</button> <button class="bg-green-600 px-[6px] py-[14px] mt-3 text-white font-semibold">Send Message</button></main>`), Popup[FILENAME], [
		[
			14,
			0,
			[[15, 4], [16, 4], [21, 4]]
	...
	function Popup($$anchor, $$props) {
		...
		const sendMessage = async () => {
			...
			console.log(...log_if_contains_state("log", response));
		};
		...
		event("click", button_1, sendMessage);
		append($$anchor, main);
